...
object Url {
    ...
    val driver_login = baseUrl + "driver_login?"
    val driver_forgot_password = baseUrl + "driver_forgot_password?"
    val DriverTripUrl = baseUrl + "driver_bookings"
    val DriverAcceptTripUrl = baseUrl + "driver_accept_trip"
    val DriverRejectTripUrl = baseUrl + "driver_reject_trip"
    ...
    const val subscribeUrl = "http://162.243.225.225:8002/subscribe"
    const val unsubscribeUrl = "http://162.243.225.225:8002/unsubscribe"
    const val carImageUrl = "http://138.68.5.43/car_image/"
    const val FacebookImgUrl = "https://graph.facebook.com/"
}
